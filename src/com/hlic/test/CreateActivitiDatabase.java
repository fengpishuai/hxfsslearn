...
public class CreateActivitiDatabase {
	public static void main(String[] args) {
		...
		pec.setJdbcUrl("jdbc:mysql://192.168.232.128:3306/activiti?useUnicode=true&characterEncoding=utf8&characterSetResults=utf8");
