...
<div class="content">
    <div class="con-header">
        <div class="con-fl con-cf">
            ...
            <div class="am-text-primary am-text-lg">初审派单</div>
        </div>
    </div>
    ...
    <div class="bottomBtn">
	    ...
	    <a class="webbtn" href="javaScript:void(0)" style="" onclick="searchs()"><span class="ico_btn_add"></span><span> 查询 </span></a>
    </div>
</div>
</body>
<script type="text/javascript">
    ...
    function saveData() {
    	dom.hlicStoGrid("saveData", "${ctx}/base/upDataDofStoreColsGrid.action");
    }
</script>
</html>