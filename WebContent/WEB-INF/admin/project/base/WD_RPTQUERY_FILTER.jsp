...
<div class="content">
    <div class="con-header">
        <div class="con-fl con-cf">
            ...
            <div class="am-text-primary am-text-lg">SQL条件配置</div>
        </div>
...
<script type="text/javascript">
    ...
    function createTable(){
    	dom.hlicStoGrid({
			"url"      : "${ctx}/base/queryStoGridPageList.action",
			"STO_ID"   : "WD_RPTQUERY_FILTER",
			"STO_KEY"  : "F_PKEY",
            "width"    : conWidth-5,
            "height"   : conHeight-56,
            "pager"    : "pager"
    ...
    function save(){
    	dom.hlicStoGrid("saveData",sys_ctx+"/base/saveStoreData.action");
    }
</script>
</html>