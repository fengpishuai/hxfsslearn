...
<div class="content">
    <div class="con-header">
        <div class="con-fl con-cf">
            ...
            <div class="am-text-primary am-text-lg">用户角色组织机构映射</div>
        </div>
...
<script type="text/javascript">
    ...
    function createGrid(){
    	dom.hlicGrid({
			"url"      : "${ctx}/base/querySysUserRoleOrgList.action",
            "width"    : conWidth-5,
            "height"   : conHeight-56,
            "colNames" : ["编号","用户", "角色","部门"],
            "colModel" : [ 
         		{name:'fPkey',index:'fPkey',editable: true, width:60}, 
                {name:'fUserId',index:'fUserId',editable: true,align:"center", width:90},
                {name:'fRoleId',index:'fRoleId',editable: true,align:"center", width:90}, 
                {name:'fCompId',index:'fCompId',editable: true,align:"center", width:90}
       		]
		});
	}
    ...
    function saveData() {
    	dom.hlicGrid("saveData", "${ctx}/base/upDataSysUserRoleOrgGrid.action");
    }
</script>
</html>